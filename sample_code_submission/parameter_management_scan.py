class Parameter_Distribution:
    ...
    parameter = {
        "SkipTHV_OnlyPredict": False,
        "ModelType": "BDT",
        "Load_Classifier": False,
        "THV_size": np.array(
            [1_000, 1_000, 1_000]
        ),  # 40_000_000,60_000_000, 20_000_000    5M for BDT 40 for NN   2_500_000 for little BDT    60_000_000, 20_000_000  80_000_000, 100_000_000, 40_000_000
        "Nb_bins_distrib": 20,
        "threshold_distrib": 0,
        ...
        "Features_VS_syst": False,
        "Print_NLL_score_biased_stacked": True,
    ...
    @classmethod
    def overwrite_size(
        cls, Algebraic_diff_Pop_Main_Sub, Main_Study_Subset, Pop_modified
    ):
        import numpy as np
        ...
        New_Pop[
            Main_Study_Subset
        ] += Algebraic_diff_Pop_Main_Sub  # algebraic addition of the subset
        ...
        if Security_Sum != np.sum(New_Pop):
            print(
                "There is a problem in the population modificiation, Ini total pop = ",
                Security_Sum,
                " ,New = ",
                np.sum(New_Pop),
            )
