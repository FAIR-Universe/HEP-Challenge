def Test_Variable_SubSize (dataset,Main_Study_Subset=0,Pop_modified=[1],Average_EndPop_MainSubset=25_000,Nb_Step=3) :

    import numpy as np
    import matplotlib.pyplot as plt
    from parameter_management_scan import Parameter_Distribution #To change the pop size
    ...
    Parameter_Distribution.overwrite_size(int(AlgebraicPopStep), Main_Study_Subset, Pop_modified )
    ...
    plt.savefig("current_dir/images/Better_Best_Mu_AMS_Thresh_Vs_TrainSize_%s_MuMthde_%s_PopStep=%s_Train_ini=%s_Holdout_ini=%s_Valid=%s.png"%(ModelType,Fitting_tamp.best_opti["mu_del_val_method"],AlgebraicPopStep,NbTrain,NbHoldout,NbValidation), facecolor='white')
    plt.show()
